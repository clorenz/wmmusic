/* ------------------------------------------------------------------------- *
$Source: /usr/local/cvs/wmmusic/src/de/christophlorenz/wmmusic/medium/DeleteStickerAction.java,v $
$Author: clorenz $
...
public class DeleteStickerAction extends CommonAction {
	
	static final Logger log;
	static {
		log = Logger.getLogger(DeleteStickerAction.class);
	}
	...
	public ActionForward commonExecute(ActionMapping mapping, ActionForm form,
		...
		try {
			db.deleteMediumTags(getUsername(), "sticker");
			statusLine = "Deleted stickers";
		} catch ( DAOException e) {
			log.error(e,e);
			statusLine = "Could not delete stickers: "+e.getMessage();
		} catch ( Exception e) {
			log.error(e,e);
			statusLine = "Could not delete stickers: "+e.getMessage();
		}
