/* ------------------------------------------------------------------------- *
$Source: /usr/local/cvs/wmmusic/src/de/christophlorenz/wmmusic/medium/Medium.java,v $
$Author: clorenz $
...
public class Medium {
	...
	static final SimpleDateFormat dateDE = new SimpleDateFormat("dd.MM.yyyy");
	static final SimpleDateFormat dateUS = new SimpleDateFormat("yyyy-MM-dd");
	static final Logger log;
	static {
		log = Logger.getLogger(Medium.class);
	}
	...
	public void setBuyDate(String buyDate) {
		...
		if ( buyDate.indexOf(".") > -1)
			try {
				date = dateDE.parse(buyDate);
			} catch (ParseException e) {
				log.error(buyDate+" is not a valid german date in form dd.mm.yyyy");
			}
		else if ( buyDate.indexOf("-") > -1)
			try {
				date = dateUS.parse(buyDate);
			} catch (ParseException e) {
				log.error(buyDate+" is not a valid us date in form yyyy-mm-dd");
			}
		
		if ( date != null) 
			this.buyDate = dateUS.format(date);
	}
	...
	public String getMediumTypeAbbrev() {
		switch (type) {
		case IMediumTypes.AUDIO_TAPE: return "C";
		case IMediumTypes.VIDEO_TAPE: return "V";
		case IMediumTypes.MD: return "M";
		case IMediumTypes.ROM: return "D";
		case IMediumTypes.FILES: return "F";
		case IMediumTypes.LP: return "L";
		case IMediumTypes.SINGLE: return "S";
		case IMediumTypes.CD: return "D";
		default: return " ";
		}
	}
